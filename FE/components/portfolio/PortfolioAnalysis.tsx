            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-gray-900 dark:text-gray-100">
                    {portfolioSummary.availableCash?.toLocaleString()}원
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600 dark:text-gray-400">
                  ...
                  <span className="font-medium text-gray-900 dark:text-gray-100">
                    {portfolioSummary.settlementCash?.toLocaleString()}원
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600 dark:text-gray-400">
                  ...
                  <span className="font-medium text-gray-900 dark:text-gray-100">
                    {portfolioSummary.withdrawableCash?.toLocaleString()}원
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-sm">
                  {portfolioSummary.stockAllocationRate > 70 ? (
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-gray-600 dark:text-gray-400">
                    {diversificationScore > 60 ? "적절한 분산" : "분산 필요"}
                  </span>
                </div>
              </div>
            </div>
