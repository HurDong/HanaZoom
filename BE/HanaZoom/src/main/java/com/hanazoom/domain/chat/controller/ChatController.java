...
public class ChatController {
    ...
    public ResponseEntity<ApiResponse<RegionChatInfo>> getRegionChatInfo(@RequestHeader("Authorization") String authHeader) {
        try {
            log.info("지역 정보 조회 요청 - Authorization: {}", authHeader.substring(0, Math.min(20, authHeader.length())) + "...");
